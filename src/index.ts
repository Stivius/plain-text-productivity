...
import {
  readDateFromConsole,
  readRecordFromConsole,
} from "./readRecordFromInput";
...
const commandsDefinitions = [{ name: "command", defaultOption: true }];

const commands = commandLineArgs(commandsDefinitions, {
